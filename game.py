...
class Game:
    def __init__(self, nb_scenes):
        ...
        self.uses = global_uses[::]
        self.probabilities = global_probabilities[::]
        self.start_time = 0
        self.elapsed_time = 0
        self.stop_time = 0
    ...
    def collide(self):
        ...
        """
        return self.scenes[floor(self.player_position)]
    ...
    def on_time(self):
        ...
        self.create_walls(self.probabilities[0])
        self.scheduler.next_event = self.start_time + self.elapsed_time + self.speeds[0]
        self.elapsed_time += self.speeds[0]
        self.uses[0] -= 1

        # Destroy first elements
        if self.uses[0] == 0:
